                    ...
                    <div className="flex-center flex-col sm:px-10">
                        ...
                        <div className="flex flex-col w-full relative">
                            <div className="feature-video-container">
                                ...
                                <div className=' overflow-hidden flex-1 h-[50vh]'>
                                    <Image src={explore2Img} alt='titanium2' className='feature-video g_grow' 
                                    width={500} height={500}
                                    // layout='fill'
                                    // objectFit='contain'
                                    />
                            ...
                            <div className='feature-text-container'>
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
                                        iPhone 15 Pro is {' '}
                                        <span className=' text-white'>the first iPhone to fearure an aerospace-grade titanium design</span>, using the same alloy that spacecraft use for missions to Mars. 
                                    </p>
                                </div>
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">
