...
const page = () => {
    ...
    return (
        <>
            {/* Hero Section */}
            <section className=' w-full text-[3vmin] h-[100vh] pt-20 flex flex-col'>
                <div className="flex justify-between px-[5vmin]">
                    <h1 className=" font-semibold text-[1.2em]">Apple Vision Pro</h1>
                    <div className="flex items-center justify-between text-[2vmin] gap-2">
                        <span className={`text-gray-500 w-6 rotate-0 lg:hidden`}> {btnSymbol}</span>
                        <div className="text-md hidden lg:flex-center gap-5 ">
                        ...
                        <span className=" bg-sky-600 rounded-full px-3 py-1 text-center hover:cursor-pointer text-white">Buy</span>
                    </div>
                </div>
                <div className="relative overflow-hidden flex-center w-full flex-1 h-full ">
                    <video className="pointer-events-none h-[100%] object-cover" autoPlay loop muted preload='none'>
                    ...
                    <div className="absolute w-full flex-center bottom-[5vmin] flex-col text-orange-600 font-medium">
                        <h1 className="text-black text-[8vmin] flex gap-5">
                            <span className="flex-center w-[2vmin]">{appleSVG}</span>
                            Vision Pro</h1>
                        <a className="hover:underline text-[.8em]">Book a demo</a>
                        <a className="hover:underline text-[.8em]">Preview visionOS2</a>
                    </div>
                </div>
            </section>
            ...
            <section className="section">
                ...
                {/* </div> */}
                <div className=" w-full flex-center flex-col gap-5 text-[1em] font-semibold text-white absolute">
                    ...
                    <button className=" hover:bg-orange-600 ease-linear duration-100 hover:text-white text-orange-600 border-[.5vmin] border-orange-600 px-4 py-2 text-[.8em] rounded-full">Watch the film</button>
                </div>
            </section>

            {/* vision pro Image */}
            <section className="section">
                <h1 className="text-black text-[2em] pb-2 flex gap-5 font-semibold"><span className="flex-center w-[2vmin]">{appleSVG}</span>Vision Pro</h1>
                ...
                <button className="border-[.5vmin] border-black hover:bg-black hover:text-white px-4 py-2 text-[1em] font-medium rounded-full"> + Take a closer look</button>
            </section>
            ...
            {/* Image Showcase */}
            <section className="section">
                <div className="flex-center gap-[5vmin] w-full px-[10vmin]">
                    <Image src="https://www.apple.com/v/apple-vision-pro/e/images/overview/design/glass_top__k3b8lzqd1l2m_large.jpg" alt="showcase1" width={500} height={500} className="w-[70%]" />
                    <Image src="https://www.apple.com/v/apple-vision-pro/e/images/overview/design/glass_side__gm4agomrwl2e_large.jpg" alt="showcase2" width={500} height={500} className="w-[70%]" />
                </div>
            ...
            <section className="section">
                ...
                <OrangeButton text="+ Learn more about design" className=" absolute bottom-[5vmin]"/>
            </section>
            ...
            {/* Values Section */}
            <section className="section">
                <div className="w-[80vmin] text-[0.8em] font-semibold text-center space-y-[1vmin]">
                    <h1>Values</h1>
                    <h1 className="text-[3vmin] font-bold">Designed to make a difference.</h1>
            ...
            {/* Use Ar Section */}
            <section className="section">
                <div className="bg-[#f5f5f8] flex-center flex-col lg:flex-row self-stretch mx-[10vmin] p-[5vmin] pb-0 gap-[5vmin] rounded-2xl">
                    <div className="flex-center lg:items-start flex-col font-semibold w-[80vmin] space-y-5 text-center lg:text-left">
                        <Image src={"https://www.apple.com/v/apple-vision-pro/e/images/overview/routers/ar_logo__bmtaba6ckk76_medium_2x.png"} alt="artoview" width={80} height={80} quality={100} className="w-[10vmin]"/>
                        <h1 className="text-[2em]">Use AR to View Apple Vision Pro.</h1>
                        <p className=" text-gray-500 text-[1em]">Open this page using Safari on your iPhone or iPad</p>
                    </div>
            ...
            {/* explore Section */}
            <section className="section">
                <div className="bg-[#f5f5f8] rounded-3xl flex-center self-stretch flex-col lg:flex-row p-[5vmin] mx-[10vmin] text-center lg:text-left gap-[5vmin]">
                    <div className="">
                        <h1 className="font-semibold text-[1.5em]">Explore Apple Vision Pro accessories.</h1>
                        <h1 className=" text-blue text-[1em] hover:underline">Shop {">"}</h1>
                    </div>
            ...
            {/* explore Section */}
            <section className="section">
                <div className="bg-[#f5f5f8] rounded-3xl flex-center flex-col self-stretch mx-[10vmin] py-[5vmin] gap-[5vmin]">
                    <Image src={"https://www.apple.com/v/apple-vision-pro/e/images/overview/routers/developers__bxrd1uafspsi_large.png"} alt="artoview" width={600} height={500} quality={100} className="w-[50vmin]"/>
                    <div className="space-y-[2vmin] text-center px-[5vmin] flex-center flex-col">
                        <h1 className="font-semibold text-[1.6em] leading-tight">An all‑new platform. <br/> An all‑new world for developers.</h1>
                        <p className="text-[.8em] w-[90%]">The possibilities for what developers can dream up and build for Apple Vision Pro are endless. And with familiar tools and frameworks like Xcode, SwiftUI, RealityKit, and ARKit, as well as support for Unity and the 3D-content preparation app Reality Composer Pro, developers have everything they need to create amazing spatial experiences.</p>
                        <h1 className=" text-blue text-[1em] hover:underline">Shop Learn more about developing for visionOS</h1>
                    </div>
                </div>                
            </section>
...
const TechnologySection = () => {
    return (
        <section className="section bg-black">
            <div className="w-[80vmin] text-white text-[1em] font-semibold text-center mb-[10vmin] space-y-5">
                <h1>Technology</h1>
                <h1 className="text-[1.8em] font-bold">Innovation you can see, hear, and feel.</h1>
                <p className="pb-[10vmin] text-gray-400"><span className="text-white">Pushing boundaries from the inside out.</span> Spatial experiences on Apple Vision Pro are only possible through groundbreaking Apple technology. Displays the size of a postage stamp that deliver more pixels than a 4K TV to each eye. Incredible advances in Spatial Audio. A revolutionary dual‑chip design featuring custom Apple silicon. A sophisticated array of cameras and sensors. All the elements work together to create an unprecedented experience you have to see to believe.
                </p>
            </div>
            ...
            <div className="w-[80vmin] text-white text-[1em] font-semibold text-center mb-[10vmin] space-y-5">
                <h1 className="text-[1.8em] font-bold">More pixels than a 4K TV. For each eye.</h1>
            ...
            <div className=" w-full relative flex-center flex-col">
                <video className="pointer-events-none w-full h-full object-cover" autoPlay muted preload='none'>
                ...
                <div className="w-[80vmin] text-white text-[1em] font-semibold text-center space-y-5">
                    <h1 className="text-[2em] font-bold">Our most advanced Spatial Audio system ever.</h1>
            ...
            <button className="text-[.8em] border-2 bg-white py-[1vmin] px-[2vmin] rounded-full font-semibold"> + Learn more about technology</ button>
        </section>
    )
}
...
const TechnologySectionEle = ({imgSrc, heading, des}:{imgSrc: string, heading: string, des: any}) => {
    return(
        <div className="w-full flex-center flex-col my-[10vmin]">
            <Image src={imgSrc} alt="insidevision" width={500} height={500} className="w-[60%]" quality={100}/>
            <div className="w-[80vmin] text-white font-semibold text-center mt-24 space-y-5">
                <h1 className="text-[2em] font-bold">{heading}</h1>
                <p className="text-gray-400 text-[1em]">{des}</p>
            </div>
        </div>
    )
}
...
const DesignedByApple = () => {
    ...
    return (
        <section className="bg-[#f4f4f7] section">
            <div className="flex-center flex-col text-[.8em] font-semibold w-[80vmin] text-center gap-5 mb-[5vmin]">
                <h1 className="">Design</h1>
                <h1 className="text-[2em] font-bold">Designed by Apple.</h1>
...
const InfoSection = ({ heading, des, btnText }: { heading: any, des: string, btnText: string }) => {
    return (
        <section className="section">
            <div className="flex-center lg:items-start flex-col gap-5 w-[80vw] lg:w-[50vw] text-center lg:flex-row lg:text-justify">
                <h1 className="text-[1em] font-bold text-nowrap">{heading}</h1>
                <div className="flex-center flex-col lg:flex">
                    <p className="text-[.8em] pb-10 font-semibold text-gray-600">{des}</p>                    
...
const VideoSection = ({ src, heading, des }: { src: string, heading: string, des: any }) => {
    return (
        <section className="relative flex-center my-12 text-[3vmin]">
            <video className="pointer-events-none w-full h-full object-cover" autoPlay muted preload='none'>
                <source src={src} />
            </video>
            <div className=" w-full h-full bg-black/20 flex-center flex-col gap-5 font-semibold text-white absolute">
                <h1 className="text-[1em] font-medium">{heading}</h1>
                <h1 className="text-[2em] text-center">{des}</h1>
            </div>
        </section>
    )
}
...
const OrangeButton = ({text, className}:{text:string, className?:string}) => {
    return (
        <button className={`hover:bg-orange-500 bg-orange-600 ease-linear duration-100 text-white px-[2vmin] py-[1.5vmin] text-[.8em] rounded-full ${className}`}>{text}</button>
    )
}