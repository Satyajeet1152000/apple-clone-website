...
export default function DashboardLayout({ children, }: { children: React.ReactNode }) {
    return (
        <main className=" bg-[#f5f5f7] w-[100%]">
            <section className='w-full text-[3vmin] h-max gap-[5vmin] border border-transparent'>                
                <div className=' flex flex-col items-start lg:items-center lg:flex-row lg:justify-between mt-[12vh]'>
